...
import { CommonMessage, PaginatedAuthorizedResources, PaginatedPolicyAssignments, PaginatedRoles, PaginatedUsers, ResourceType, Role } from '../../types/graphql.v2';
...
export declare class RolesManagementClient {
     ...
     * @memberof RolesManagementClient
     */
    listUsers(code: string, namespace?: string): Promise<DeepPartial<PaginatedUsers>>;
    /**
     * @name addUsers
     * @name_zh 添加用户
     * @description 添加用户
