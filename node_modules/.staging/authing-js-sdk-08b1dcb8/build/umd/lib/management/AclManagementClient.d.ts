...
export declare class AclManagementClient {
     ...
     */
    allow(userId: string, resource: string, action: string): Promise<CommonMessage>;
    /**
     * @name isAllowed
     ...
     *
     */
    isAllowed(userId: string, resource: string, action: string): Promise<boolean>;
    /**
     ...
     *
     */
    listResourcePermissions(): Promise<void>;
}
