...
import { AuthenticationClientOptions, ICasParams, ILogoutParams, IOauthParams, IOidcParams, PasswordSecurityLevel, SecurityLevel } from './types';
import { CheckPasswordStrengthResult, CommonMessage, EmailScene, JwtTokenStatus, PaginatedAuthorizedResources, RefreshToken, RegisterProfile, ResourceType, UpdateUserInput, User, UserDefinedData } from '../../types/graphql.v2';
...
export declare class AuthenticationClient {
     ...
     * @memberof AuthenticationClient
     */
    sendSmsCode(phone: string): Promise<CommonMessage>;
    /**
     * @name loginByEmail
     * @name_zh 使用邮箱登录
     ...
     * @memberof AuthenticationClient
     */
    resetPasswordByPhoneCode(phone: string, code: string, newPassword: string): Promise<CommonMessage>;
    /**
     ...
     * @memberof AuthenticationClient
     */
    updateProfile(updates: UpdateUserInput): Promise<User>;
    /**
     * @name updatePassword
     * @name_zh 更新用户密码
     * @description 更新用户密码
     ...
     * @memberof AuthenticationClient
     */
    updatePhone(phone: string, phoneCode: string, oldPhone?: string, oldPhoneCode?: string): Promise<User>;
    /**
     * @name updateEmail
     * @name_zh 更新用户邮箱
     ...
     * @memberof AuthenticationClient
     */
    bindPhone(phone: string, phoneCode: string): Promise<User>;
    /**
     * @name unbindPhone
     * @name_zh 解绑手机号
     * @description 用户解绑手机号
     ...
     * @memberof AuthenticationClient
     */
    loginByAd(username: string, password: string): Promise<User>;
    /**
     * @description 上传图片
     */
    private uploadPhoto;
     ...
     *
     */
    setUdfValue(data: KeyValuePair): Promise<void>;
    /**
    ...
    _getAccessTokenByCodeWithClientSecretPost(code: string): Promise<any>;
    _getAccessTokenByCodeWithClientSecretBasic(code: string): Promise<any>;
    _getAccessTokenByCodeWithNone(code: string): Promise<any>;
    getAccessTokenByCode(code: string): Promise<any>;
    getAccessTokenByClientCredentials(scope: string, options?: {
        accessKey: string;
        accessSecret: string;
    }): Promise<any>;
    getUserInfoByAccessToken(accessToken: string): Promise<any>;
