...
import { CommonMessage, Group, PaginatedAuthorizedResources, PaginatedGroups, PaginatedUsers, ResourceType } from '../../types/graphql.v2';
...
export declare class GroupsManagementClient {
     ...
     * @memberof GroupsManagementClient
     */
    listUsers(code: string, page?: number, limit?: number): Promise<DeepPartial<PaginatedUsers>>;
    /**
     * @name addUsers
     * @name_zh 添加用户
     * @description 添加用户
