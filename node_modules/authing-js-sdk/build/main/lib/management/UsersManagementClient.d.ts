...
import { User, PaginatedUsers, CreateUserInput, RefreshToken, CommonMessage, UpdateUserInput, PaginatedGroups, PaginatedRoles, PaginatedAuthorizedResources, ResourceType } from '../../types/graphql.v2';
...
export declare class UsersManagementClient {
    ...
    constructor(options: ManagementClientOptions, graphqlClient: GraphqlClient, httpClient: HttpClient, tokenProvider: ManagementTokenProvider, publickKeyManager: PublicKeyManager);
    /**
     * @name create
     * @name_zh 创建用户
    ...
    list(page?: number, limit?: number): Promise<{
        ...
        list: {
            ...
            arn: string;
            userPoolId: string;
            status?: import("../../types/graphql.v2").UserStatus;
            username?: string;
            email?: string;
     ...
     * @memberof UsersManagementClient
     */
    listArchivedUsers(page?: number, limit?: number): Promise<{
        totalCount: number;
        list: {
            id: string;
            arn: string;
     ...
     * @param data
     */
    setUdfValue(userId: string, data: KeyValuePair): Promise<void>;
    /**
